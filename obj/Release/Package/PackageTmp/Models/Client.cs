...
namespace eClub.Models
{
    ...
    public class Client
    {
        ...
        public IEnumerable<DescriptionTables> dCitizenship { get; set; }
        public IEnumerable<DescriptionTables> dIncomeRange { get; set; }
        public IEnumerable<DescriptionTables> dOccupation { get; set; }
        public IEnumerable<DescriptionTables> dClientSource { get; set; }
