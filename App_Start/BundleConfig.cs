...
namespace eClub
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/eClub").Include(
                    "~/Scripts/eClub/app.js")); //,
                    //"~/Scripts/eClub/demo.js"));

            bundles.Add(new ScriptBundle("~/bundles/eClub_Dashboard").Include(
               "~/Scripts/eClub/dashboard.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css/eClub").Include(
                      "~/Content/css/eClub.min.css"));    
            ...
            bundles.Add(new StyleBundle("~/bundles/backstretch").Include(
                      "~/Scripts/plugins/backstretch/jquery.backstretch*"));
