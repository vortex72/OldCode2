...
namespace eClub.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            t_client.dGender = LoadList("dGender");
            t_client.dMaritalStatus = LoadList("dMaritalStatus");
            t_client.dCitizenship = LoadList("dCitizenship");
            t_client.dIncomeRange = LoadList("dIncomeRange");
            t_client.dOccupation = LoadList("dOccupation");
            t_client.dClientSource = LoadList("dClientSource");
